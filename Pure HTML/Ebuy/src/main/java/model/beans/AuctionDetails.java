...
public class AuctionDetails {
	...
	/**
	 * Return the minimum offer a User has placed
	 * so far. If no Offers have been placed,
	 * this method simply returns 0f.
	 * 
	 * If this method is called after the auction
	...
	/**
	 * Return the minimum offer a User can place for this Auction.
	...
	public double getMinimumOffer() {
		return Math.max(this.basePrice, this.maximumOffer) + this.minimumRise;
	}
